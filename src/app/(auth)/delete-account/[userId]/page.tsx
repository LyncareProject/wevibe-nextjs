        ...
        >
          {({ isSubmitting, errors, touched }) => (
            <Form className="flex flex-col gap-2 ">
              ...
              <p className='mb-10 text-center text-xl font-semibold'>정말 탈퇴하시겠습니까?</p>
              ...
              <Button type="submit" disabled={isSubmitting} className="mb-12 mt-2 flex justify-center bg-[#DB7777] font-bold  text-[#ffffff] ">
                회원탈퇴
              </Button>
            </Form>
          )}
