          ...
          {({ isSubmitting, errors, touched }) => (
           ...
           <div className=' relative'>
              <InputFormik
                ...
                errors={errors}
              />
              <Image className=' absolute left-[12px] top-[60px]'
              ...
              <InputFormik
                ...
                errors={errors}
              />
               <Image className=' absolute left-[13px] top-[62px]'
              ...
              <InputFormik
                ...
                errors={errors}
              />
               <Image className=' absolute left-[12px] top-[58px]'
              ...
              <InputFormik
                ...
                errors={errors}
              />
              <p className=' absolute left-[12px] top-[60px]'>
              <Image 
